"use strict"; return ((function() {
  ...
  function updateSpanFromRequest(span, request) {
  ...
  function setResponseAttributes(span, response, errorThreshold) {
  ...
  function updateSpanFromClientResponse(span, response) {
  ...
  // errors.
  function updateSpanFromServerResponse(span, response) {
    setResponseAttributes(span, response, 500);
  }
  // deno-lint-ignore no-explicit-any
  function updateSpanFromError(span, error) {
