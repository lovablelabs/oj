"use strict"; return ((function() {
  ...
  const { isErrorStackTraceLimitWritable } = core.loadExtScript("ext:deno_node/internal/errors.ts");
  const { getErrorSourceExpression } = core.loadExtScript("ext:deno_node/internal/errors/error_source.ts");
  const { Error, ErrorCaptureStackTrace, SafeRegExp, StringPrototypeCharCodeAt, StringPrototypeReplace } = primordials;
