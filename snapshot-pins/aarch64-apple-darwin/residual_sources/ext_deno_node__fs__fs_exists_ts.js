...
const { kCustomPromisifiedSymbol } = core.loadExtScript("ext:deno_node/internal/util.mjs");
...
export function existsSync(path) {
  try {
    ...
    if (showExistsDeprecation && err?.code === "ERR_INVALID_ARG_TYPE") {
      lazyProcess().default.emitWarning("Passing invalid argument types to fs.existsSync is deprecated", "DeprecationWarning", "DEP0187");
