"use strict"; return ((function() {
  ...
  const { Error, PromisePrototypeThen, ObjectPrototypeIsPrototypeOf } = primordials;
  function lstat(path, optionsOrCallback, maybeCallback) {
    ...
    PromisePrototypeThen(Deno.lstat(validatedPath), (stat)=>callback(null, lazyStatUtils().CFISBIS(stat, options.bigint)), (err)=>{
