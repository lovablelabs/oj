...
const _consoleDesc = windowOrWorkerGlobalScope.console;
const console = typeof _consoleDesc.get === "function" ? _consoleDesc.get() : _consoleDesc.value;
const { ObjectAssign } = primordials;
ObjectAssign(console, {
  Console
});
export default console;
export { Console };
export const { assert, clear, count, countReset, debug, dir, dirxml, error, group, groupCollapsed, groupEnd, info, log, profile, profileEnd, table, time, timeEnd, timeLog, timeStamp, trace, warn } = console;
// deno-lint-ignore no-explicit-any
export const indentLevel = console?.indentLevel;
