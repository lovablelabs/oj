"use strict"; return ((function() {
  ...
  const { StringPrototypeToUpperCase, StringPrototypeCharAt, StringPrototypeSlice, Date, DatePrototypeGetTime } = primordials;
  const { arch, versions } = core.loadExtScript("ext:deno_node/_process/process.ts");
  ...
  function getReport(_err) {
    ...
    return {
      header: {
        ...
        release: {
          name: "node",
          headersUrl: "https://nodejs.org/download/release/v21.2.0/node-v21.2.0-headers.tar.gz",
          sourceUrl: "https://nodejs.org/download/release/v21.2.0/node-v21.2.0.tar.gz"
        },
        osName: StringPrototypeToUpperCase(StringPrototypeCharAt(Deno.build.os, 0)) + StringPrototypeSlice(Deno.build.os, 1),
