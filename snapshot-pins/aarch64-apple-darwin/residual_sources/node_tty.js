...
const { FunctionPrototypeCall, ObjectPrototypeIsPrototypeOf, ObjectSetPrototypeOf } = primordials;
const { ERR_INVALID_FD, ERR_TTY_INIT_FAILED } = core.loadExtScript("ext:deno_node/internal/errors.ts");
