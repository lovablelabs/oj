...
import { op_fs_cwd, op_get_env_no_permission_check, op_import_sync, op_import_sync_with_source, op_module_default_resolve, op_module_hooks_poll_load, op_module_hooks_register, op_module_hooks_respond_load, op_napi_open, op_node_has_child_ipc_pipe, op_node_strip_typescript_types, op_require_as_file_path, op_require_break_on_next_statement, op_require_can_parse_as_esm, op_require_init_paths, op_require_is_deno_dir_package, op_require_is_maybe_cjs, op_require_is_request_relative, op_require_node_module_paths, op_require_package_imports_resolve, op_require_path_basename, op_require_path_dirname, op_require_path_is_absolute, op_require_path_resolve, op_require_proxy_path, op_require_read_file, op_require_read_package_scope, op_require_real_path, op_require_resolve_deno_dir, op_require_resolve_exports, op_require_resolve_lookup_paths, op_require_stat, op_require_try_self } from "ext:core/ops";
const { ArrayIsArray, ArrayPrototypeIncludes, ArrayPrototypeIndexOf, ArrayPrototypeJoin, ArrayPrototypeMap, ArrayPrototypePush, ArrayPrototypeSlice, ArrayPrototypeSort, ArrayPrototypeSplice, Error, JSONParse, ObjectCreate, ObjectDefineProperty, ObjectEntries, ObjectGetOwnPropertyDescriptor, ObjectGetPrototypeOf, ObjectHasOwn, ObjectKeys, ObjectPrototype, ObjectSetPrototypeOf, Proxy, ReflectSet, RegExpPrototypeExec, RegExpPrototypeTest, SafeArrayIterator, SafeMap, SafeSet, SafeWeakMap, SetPrototypeAdd, SetPrototypeDelete, SetPrototypeHas, String, StringPrototypeCharCodeAt, StringPrototypeEndsWith, StringPrototypeIncludes, StringPrototypeIndexOf, StringPrototypeLastIndexOf, StringPrototypeMatch, StringPrototypeReplace, StringPrototypeSlice, StringPrototypeSplit, StringPrototypeStartsWith, SyntaxError, TypeError } = primordials;
...
const internalAsyncHooks = core.loadExtScript("ext:deno_node/internal/async_hooks.ts");
const { emitAfter: internalAsyncHooksEmitAfter, emitBefore: internalAsyncHooksEmitBefore, emitDestroy: internalAsyncHooksEmitDestroy, emitInit: internalAsyncHooksEmitInit } = internalAsyncHooks;
...
const diagnosticsChannel = core.loadExtScript("ext:deno_node/diagnostics_channel.js").default;
...
const internalEventTarget = core.createLazyLoader("ext:deno_node/internal/event_target.mjs");
const internalFsUtils = core.createLazyLoader("ext:deno_node/internal/fs/utils.mjs");
...
const lazyInternalFsPromises = core.createLazyLoader("ext:deno_node/internal/fs/promises.ts");
...
const internalStreamsLazyTransform = core.createLazyLoader("ext:deno_node/internal/streams/lazy_transform.js");
const internalUtil = core.loadExtScript("ext:deno_node/internal/util.mjs");
const internalUtilDebuglog = core.loadExtScript("ext:deno_node/internal/util/debuglog.ts");
const internalUtilInspect = core.loadExtScript("ext:deno_node/internal/util/inspect.mjs");
const internalValidators = core.loadExtScript("ext:deno_node/internal/validators.mjs");
const internalConsole = core.loadExtScript("ext:deno_node/internal/console/constructor.mjs").default;
...
let _processLazy;
const _processMod = ()=>_processLazy ??= core.createLazyLoader("node:process")().default;
const process = new Proxy({
  __proto__: null
}, {
...
const internalRepl = core.createLazyLoader("ext:deno_node/internal/repl.ts");
...
const workerThreads = core.loadExtScript("ext:deno_node/worker_threads.ts");
...
const internalOptions = core.loadExtScript("ext:deno_node/internal/options.ts");
...
const lazyNodeModules = {
  ...
  "async_hooks": ()=>core.loadExtScript("ext:deno_node/async_hooks.ts").default,
  ...
  "dns/promises": ()=>core.loadExtScript("ext:deno_node/dns/promises.ts").default,
  ...
  "string_decoder": ()=>core.loadExtScript("ext:deno_node/string_decoder.ts").default,
  "timers": ()=>core.loadExtScript("ext:deno_node/timers.ts"),
  "timers/promises": ()=>core.loadExtScript("ext:deno_node/timers/promises.ts"),
  "util/types": ()=>core.loadExtScript("ext:deno_node/internal/util/types.ts"),
  "vm": ()=>core.loadExtScript("ext:deno_node/vm.js").default,
  "internal/assert/myers_diff": ()=>core.loadExtScript("ext:deno_node/internal/assert/myers_diff.js").default,
  "internal/crypto/certificate": ()=>core.loadExtScript("ext:deno_node/internal/crypto/certificate.ts").default,
  "internal/crypto/diffiehellman": ()=>core.loadExtScript("ext:deno_node/internal/crypto/diffiehellman.ts").default,
  "internal/crypto/hash": ()=>core.loadExtScript("ext:deno_node/internal/crypto/hash.ts").default,
  "internal/crypto/hkdf": ()=>core.loadExtScript("ext:deno_node/internal/crypto/hkdf.ts").default,
  "internal/crypto/keygen": ()=>core.loadExtScript("ext:deno_node/internal/crypto/keygen.ts").default,
  "internal/crypto/keys": ()=>core.loadExtScript("ext:deno_node/internal/crypto/keys.ts").default,
  "internal/crypto/pbkdf2": ()=>core.loadExtScript("ext:deno_node/internal/crypto/pbkdf2.ts").default,
  "internal/crypto/random": ()=>core.loadExtScript("ext:deno_node/internal/crypto/random.ts").default,
  "internal/crypto/scrypt": ()=>core.loadExtScript("ext:deno_node/internal/crypto/scrypt.ts").default,
  "internal/crypto/sig": ()=>core.loadExtScript("ext:deno_node/internal/crypto/sig.ts").default,
  "internal/crypto/util": ()=>core.loadExtScript("ext:deno_node/internal/crypto/util.ts").default,
  "internal/crypto/x509": ()=>core.loadExtScript("ext:deno_node/internal/crypto/x509.ts").default,
  "internal/dgram": ()=>core.loadExtScript("ext:deno_node/internal/dgram.ts").default,
  "internal/deps/undici/undici": ()=>core.loadExtScript("ext:deno_node/internal/deps/undici/undici.js").default,
  "internal/dns/promises": ()=>core.loadExtScript("ext:deno_node/internal/dns/promises.ts").default,
  "internal/priority_queue": ()=>core.loadExtScript("ext:deno_node/internal/priority_queue.ts").default,
  "internal/readline/utils": ()=>core.loadExtScript("ext:deno_node/internal/readline/utils.mjs").default,
  "internal/streams/add-abort-signal": ()=>core.loadExtScript("ext:deno_node/internal/streams/add-abort-signal.js").default,
  "internal/streams/state": ()=>core.loadExtScript("ext:deno_node/internal/streams/state.js").default,
  "internal/socketaddress": ()=>core.loadExtScript("ext:deno_node/internal/socketaddress.js"),
  "internal/test/binding": ()=>core.loadExtScript("ext:deno_node/internal/test/binding.ts"),
  "internal/timers": ()=>core.loadExtScript("ext:deno_node/internal/timers.mjs"),
  ...
  "internal/worker/js_transferable": ()=>core.loadExtScript("ext:deno_node/internal/worker/js_transferable.js"),
  "internal/webstreams/adapters": ()=>core.loadExtScript("ext:deno_node/internal/webstreams/adapters.js"),
  "internal/webstreams/readablestream": ()=>core.loadExtScript("ext:deno_node/internal/webstreams/readablestream.js"),
  "internal/webstreams/util": ()=>core.loadExtScript("ext:deno_node/internal/webstreams/util.js"),
  ...
  "internal/http": ()=>core.loadExtScript("ext:deno_node/internal/http.ts").default,
  "internal/http2/core": ()=>core.loadExtScript("ext:deno_node/internal/http2/core.ts").default,
  "internal/http2/util": ()=>core.loadExtScript("ext:deno_node/internal/http2/util.ts").default,
  ...
  "tls": ()=>tls().default,
  "internal/crypto/cipher": ()=>core.loadExtScript("ext:deno_node/internal/crypto/cipher.ts").default,
  "_tls_common": ()=>core.loadExtScript("ext:deno_node/_tls_common.ts").default,
  "_tls_wrap": ()=>core.loadExtScript("ext:deno_node/_tls_wrap.js").default,
  "repl": ()=>repl().default,
  "internal/repl": ()=>internalRepl().default,
  "fs/promises": ()=>core.loadExtScript("ext:deno_node/fs/promises.ts").fsPromises,
  "test/reporters": ()=>core.loadExtScript("ext:deno_node/test/reporters.ts").default,
  ...
  "internal/child_process": ()=>core.loadExtScript("ext:deno_node/internal/child_process.ts").default,
  "stream/web": ()=>core.loadExtScript("ext:deno_node/stream/web.js"),
  "internal/js_stream_socket": ()=>core.loadExtScript("ext:deno_node/internal/js_stream_socket.js").default,
  "internal/net": ()=>core.loadExtScript("ext:deno_node/internal/net.ts"),
  "internal/tty": ()=>core.createLazyLoader("ext:deno_node/internal/tty.js")(),
  ...
  "stream/consumers": ()=>core.loadExtScript("ext:deno_node/stream/consumers.js"),
  "stream/promises": ()=>core.createLazyLoader("node:stream/promises")().default,
  ...
  "inspector/promises": ()=>core.loadExtScript("ext:deno_node/inspector/promises.js"),
  ...
  "trace_events": ()=>core.loadExtScript("ext:deno_node/trace_events.ts").default,
  "v8": ()=>core.loadExtScript("ext:deno_node/v8.ts"),
  "wasi": ()=>core.loadExtScript("ext:deno_node/wasi.ts").default,
  "_stream_duplex": ()=>core.loadExtScript("ext:deno_node/internal/streams/duplex.js").default,
  "_stream_passthrough": ()=>core.loadExtScript("ext:deno_node/internal/streams/passthrough.js").default,
  "_stream_readable": ()=>core.loadExtScript("ext:deno_node/internal/streams/readable.js").default,
  "_stream_transform": ()=>core.loadExtScript("ext:deno_node/internal/streams/transform.js").default,
  "_stream_writable": ()=>core.loadExtScript("ext:deno_node/internal/streams/writable.js").default
};
  ...
  function nextResolve(spec, ctx) {
    ...
    if (index >= resolveHooks.length) {
      ...
      try {
        ...
        const resolved = Module._resolveFilename(spec, parent, isMain, options);
        let resolvedUrl;
    ...
    if (!nextCalled && !result?.shortCircuit) {
      throw new internalErrors.ERR_INVALID_RETURN_PROPERTY_VALUE("true", "resolve", "shortCircuit", result?.shortCircuit);
    }
    if (result?.shortCircuit && typeof result?.url !== "string") {
      const err = new TypeError('Expected a URL string to be returned for the "url" from the "resolve" hook');
...
function executeLoadHookChain(fileUrl, context) {
  ...
  function nextLoad(loadUrl, ctx) {
    ...
    if (index >= loadHooks.length) {
      ...
      const filePath = StringPrototypeStartsWith(loadUrl, "file://") ? url.fileURLToPath(loadUrl) : loadUrl;
    ...
    if (!nextCalled && !result?.shortCircuit) {
      throw new internalErrors.ERR_INVALID_RETURN_PROPERTY_VALUE("true", "load", "shortCircuit", result?.shortCircuit);
    }
    if (result?.shortCircuit && !isValidLoadHookSource(result?.source, result?.format)) {
      const err = new TypeError('Expected a string, an ArrayBuffer, or a TypedArray to be returned for the "source" from the "load" hook');
      err.code = "ERR_INVALID_RETURN_PROPERTY_VALUE";
      throw err;
    }
    return result;
...
function isValidLoadHookSource(source, format) {
  ...
  return typeof source === "string" || core.isAnyArrayBuffer(source) || core.isArrayBufferView(source);
}
function loadHookSourceToString(source) {
  ...
  return (utf8Decoder ??= new TextDecoder()).decode(new Uint8Array(source.buffer, source.byteOffset, source.byteLength));
}
...
function executeEsmResolveHookChain(specifier, context) {
  ...
  function nextResolve(spec, ctx) {
    ...
    if (index >= resolveHooks.length) {
      ...
      insideResolveHook = true;
      try {
        const resolved = op_module_default_resolve(spec, currentContext.parentURL ?? "");
        return {
          url: resolved,
          shortCircuit: true
        };
    ...
    const result = hook(spec, currentContext, wrappedNext);
    if (!nextCalled && !result?.shortCircuit) {
      throw new TypeError("resolve hook must return { shortCircuit: true } or call nextResolve");
    }
    return result;
  }
  return nextResolve(specifier, context);
...
function executeEsmLoadHookChain(fileUrl, context) {
  ...
  function nextLoad(loadUrl, ctx) {
    ...
    const result = hook(loadUrl, currentContext, wrappedNext);
    if (!nextCalled && !result?.shortCircuit) {
      throw new TypeError("load hook must return { shortCircuit: true } or call nextLoad");
    }
    return result;
  }
...
function findPackageRootFromNodeModules(filepath) {
  ...
  if (StringPrototypeStartsWith(parts[0], "@") && parts.length > 1) {
    ...
    return StringPrototypeSlice(filepath, 0, afterNm) + parts[0] + sep + parts[1];
  }
...
function tryPackage(requestPath, exts, isMain, originalPath) {
  ...
  const packageRoot = findPackageRootFromNodeModules(requestPath) ?? requestPath;
  // Ensure the resolved main path doesn't escape the package directory
  // via path traversal (e.g. "main": "../../secret.json")
  if (!StringPrototypeStartsWith(filename, packageRoot + "/") && !StringPrototypeStartsWith(filename, packageRoot + "\\") && filename !== packageRoot) {
  ...
  let actual = tryFile(filename, isMain) || tryExtensions(filename, exts, isMain) || tryExtensions(pathResolve(filename, "index"), exts, isMain);
  if (actual === false) {
    ...
    if (!actual) {
      ...
      process.emitWarning(`Invalid 'main' field in '${packageJsonPath}' of '${pkg}'. ` + "Please either fix that or report it to the module author", "DeprecationWarning", "DEP0128");
    }
  }
  return actual;
}
...
function getExportsForCircularRequire(module) {
  if (module.exports && // Skip Proxy module.exports so the warning machinery never invokes the
  // user-visible getPrototypeOf / setPrototypeOf traps. Matches the
  // !isProxy(...) guard in Node's lib/internal/modules/cjs/loader.js.
  !core.isProxy(module.exports) && ObjectGetPrototypeOf(module.exports) === ObjectPrototype && // Exclude transpiled ES6 modules / TypeScript code because those may
...
function emitParentDeprecation() {
  ...
  process.emitWarning("module.parent is deprecated due to accuracy issues. Please use " + "require.main to find program entry point instead.", "DeprecationWarning", "DEP0144");
}
...
function resolveExports(modulesPath, request, parentPath, usesLocalNodeModulesDir) {
  ...
  return op_require_resolve_exports(usesLocalNodeModulesDir, modulesPath, request, name, expansion, parentPath ?? "") ?? false;
}
Module._findPath = function(request, paths, isMain, parentPath) {
  ...
  for(let i = 0; i < paths.length; i++){
    ...
    if (!absoluteRequest) {
      const exportsResolved = resolveExports(curPath, request, parentPath, usesLocalNodeModulesDir);
      if (exportsResolved) {
    ...
    if (usesLocalNodeModulesDir) {
      ...
      basePath = isDenoDirPackage && !isRelative ? pathResolve(curPath, packageSpecifierSubPath(request)) : pathResolve(curPath, request);
    }
    let filename;
...
Module._resolveLookupPaths = function(request, parent) {
  if (typeof request !== "string") {
    throw new internalErrors.ERR_INVALID_ARG_TYPE("request", "string", request);
  }
  // Return null for built-in modules, matching Node.js behavior.
  // Libraries like requizzle rely on this to detect native modules.
  const normalizedRequest = StringPrototypeStartsWith(request, "node:") ? StringPrototypeSlice(request, 5) : request;
  if (isBuiltin(request) || normalizedRequest in nativeModuleExports) {
    return null;
  }
  const paths = [];
  if (op_require_is_request_relative(request)) {
    ArrayPrototypePush(paths, parent?.filename ? op_require_path_dirname(parent.filename) : ".");
    return paths;
  }
  if (!usesLocalNodeModulesDir && parent?.filename && parent.filename.length > 0) {
    const denoDirPath = op_require_resolve_deno_dir(request, parent.filename);
    if (denoDirPath) {
      ArrayPrototypePush(paths, denoDirPath);
    }
  }
  const lookupPathsResult = op_require_resolve_lookup_paths(request, parent?.paths, parent?.filename ?? "");
...
Module._load = function(request, parent, isMain) {
  ...
  if (typeof request === "string" && StringPrototypeStartsWith(request, "node:") && !(hookEntries.length > 0 && !insideResolveHook)) {
    const id = StringPrototypeSlice(request, 5);
    if (!(id in nativeModuleExports) || StringPrototypeStartsWith(id, "internal/")) {
  ...
  const cachedModule = Module._cache[filename];
  if (cachedModule !== undefined && !StringPrototypeStartsWith(filename, "node:")) {
    updateChildren(parent, cachedModule, true);
    if (!cachedModule.loaded) {
      return getExportsForCircularRequire(cachedModule);
    }
  ...
  const isBuiltinFilename = StringPrototypeStartsWith(filename, "node:") || nativeModuleCanBeRequiredByUsers(filename);
  if (isBuiltinFilename) {
    const builtinFilename = StringPrototypeStartsWith(filename, "node:") ? filename : "node:" + filename;
    // Slice 'node:' prefix
    ...
    if (builtinHookResult != null) {
      ...
      if (result.format && result.format !== "builtin" && result.source != null) {
  ...
  try {
    try {
      ...
      } else if (module.exports && // Skip Proxy module.exports so the cleanup pass after a circular
      // require doesn't invoke user-visible getPrototypeOf traps. Matches
      // Node's lib/internal/modules/cjs/loader.js behavior.
      !core.isProxy(module.exports) && ObjectGetPrototypeOf(module.exports) === CircularRequirePrototypeWarningProxy) {
    ...
    if (isMain && parent === null && typeof process !== "undefined" && typeof process._fatalException === "function") {
...
Module._resolveFilename = function(request, parent, isMain, options) {
  ...
  if (hookEntries.length > 0 && !insideResolveHook && // Dynamic import of CJS goes through an internal self-require to execute
  ...
  request !== parent?.filename) {
    const parentURL = parent?.[kSourceURL] ?? (parent?.filename ? url.pathToFileURL(parent.filename).href : undefined);
    const context = {
      conditions: [
        "node",
        "require"
    ...
    const result = executeResolveHookChain(request, context, parent, isMain, options);
    if (result != null && result.url != null) {
      if (options?.[requireResolveOptionsMarker] && StringPrototypeStartsWith(result.url, "node:")) {
    ...
    if (ArrayIsArray(options.paths)) {
      ...
      for(let i = 0; i < options.paths.length; i++){
        if (typeof options.paths[i] !== "string") {
          throw new internalErrors.ERR_INVALID_ARG_TYPE("options.paths", "string", options.paths[i]);
        }
      }
      const isRelative = op_require_is_request_relative(request);
      if (isRelative) {
        ...
        paths = [];
        for(let i = 0; i < options.paths.length; i++){
          ArrayPrototypePush(paths, pathResolve(process.cwd(), options.paths[i]));
        }
      } else {
      ...
      throw new internalErrors.ERR_INVALID_ARG_VALUE("options.paths", options.paths);
    }
  } else {
    paths = Module._resolveLookupPaths(request, parent);
  }
  if (parent?.filename) {
    if (request[0] === "#") {
      const maybeResolved = op_require_package_imports_resolve(parent.filename, request);
      if (maybeResolved) {
  ...
  const selfResolved = parentPath != null ? op_require_try_self(parentPath, request) : undefined;
  if (selfResolved) {
  ...
  if (!usesLocalNodeModulesDir && ArrayIsArray(options?.paths) && request[0] !== "." && request[0] !== "#" && !request.startsWith("file:///") && !op_require_is_request_relative(request) && !op_require_path_is_absolute(request)) {
    try {
  ...
  if (typeof request === "string" && (StringPrototypeEndsWith(request, "$deno$eval.cjs") || StringPrototypeEndsWith(request, "$deno$eval.cts") || StringPrototypeEndsWith(request, "$deno$stdin.cjs") || StringPrototypeEndsWith(request, "$deno$stdin.cts"))) {
    return request;
  }
  const requireStack = [];
  ...
  if (hasLoadHooks) {
    {
      ...
      } else if (StringPrototypeStartsWith(this.filename, "file://") || StringPrototypeIncludes(this.filename, "://")) {
...
Module.prototype.require = function(id) {
  ...
  if (id === "") {
    throw new internalErrors.ERR_INVALID_ARG_VALUE("id", id, "must be a non-empty string");
  }
  requireDepth++;
  ...
  try {
    if (moduleRequireDc.hasSubscribers) {
      return moduleRequireDc.traceSync(Module._load, {
        parentFilename,
        id
...
function isEsmSyntaxError(error) {
  return error instanceof SyntaxError && (StringPrototypeIncludes(error.message, "Cannot use import statement outside a module") || StringPrototypeIncludes(error.message, "Unexpected token 'export'"));
}
...
function wrapSafe(filename, content, cjsModuleInstance, format) {
  ...
  let err;
  if (patched) {
    [f, err] = core.evalContext(Module.wrap(content), url.pathToFileURL(filename).toString(), [
      format !== "module"
    ]);
  } else {
    [f, err] = core.compileFunction(content, url.pathToFileURL(filename).toString(), [
      format !== "module"
    ], [
      "exports",
      "require",
...
Module.prototype._compile = function(content, filename, format, sourceFromHook = false) {
  const useSourceImport = sourceFromHook || SetPrototypeDelete(cjsHookResolvedFilenames, filename);
  if (format === "module") {
  ...
  try {
    ...
    if (format !== "commonjs" && err instanceof SyntaxError && (op_require_can_parse_as_esm(content) || isEsmSyntaxError(err))) {
      return loadESMFromCJS(this, filename, content, useSourceImport);
    }
    throw err;
  }
...
Module._extensions[".js"] = function(module, filename) {
  ...
  if (StringPrototypeEndsWith(filename, ".js") || StringPrototypeEndsWith(filename, ".ts") || StringPrototypeEndsWith(filename, ".jsx") || StringPrototypeEndsWith(filename, ".tsx")) {
...
function _throwRequireAsyncModule(specifier, module) {
  ...
  throw new internalErrors.ERR_REQUIRE_ASYNC_MODULE(specifier, parent, getRequireStack(parentModule));
}
function loadESMFromCJS(module, filename, code, sourceFromHook = false) {
  const specifier = url.pathToFileURL(filename).toString();
  let namespace;
  try {
    namespace = sourceFromHook && code !== undefined ? op_import_sync_with_source(specifier, code) : op_import_sync(specifier);
  } catch (e) {
    if (e instanceof Error && StringPrototypeIncludes(e.message, "Top-level await is not allowed in synchronous evaluation")) {
...
Module._extensions[".node"] = function(module, filename) {
  ...
  module.exports = op_napi_open(filename, globalThis, buffer.Buffer.from, reportError, napiAsyncHooksEmitInit, napiAsyncHooksEmitBefore, napiAsyncHooksEmitAfter, napiAsyncHooksEmitDestroy);
};
...
const kCreateRequireError = "must be a file URL object, file URL string, or absolute path string";
function createRequire(filenameOrUrl) {
  let fileUrlStr;
  if (filenameOrUrl instanceof URL) {
    if (filenameOrUrl.protocol !== "file:") {
      throw new internalErrors.ERR_INVALID_ARG_VALUE("filename", filenameOrUrl, kCreateRequireError);
    }
...
function isBuiltin(moduleName) {
  ...
  return moduleName in nativeModuleExports && !StringPrototypeStartsWith(moduleName, "internal/");
}
...
function packageNameFromBareSpecifier(specifier) {
  if (op_require_is_request_relative(specifier) || isAbsolute(specifier) || RegExpPrototypeTest(RE_URL_SCHEME, specifier)) {
    return null;
  }
...
function findPackageJSON(specifier, base = undefined) {
  const specifierString = specifier instanceof URL ? specifier.href : String(specifier);
...
function maybeEmitNativeModuleDeprecation(request) {
  ...
  process.emitWarning(deprecation[0], "DeprecationWarning", deprecation[1]);
}
  ...
  while(iter.pos < mappings.length){
    ...
    if (iter.pos < mappings.length) {
      ...
      if (next !== "," && next !== ";") {
        ...
        const originalLine = previousOriginalLine + decodeVLQ(mappings, iter);
        previousOriginalLine = originalLine;
        const originalColumn = previousOriginalColumn + decodeVLQ(mappings, iter);
        previousOriginalColumn = originalColumn;
        let source = sources[sourceIndex] || "";
        if (sourceRoot && !StringPrototypeStartsWith(source, "/") && !RegExpPrototypeTest(/^\w+:\/\//, source)) {
          source = sourceRoot + source;
        }
        let name;
        // Check for optional name index
        if (iter.pos < mappings.length && mappings[iter.pos] !== "," && mappings[iter.pos] !== ";") {
 ...
 */ function findEntryInMappings(entries, line, column) {
  ...
  while(low <= high){
    ...
    const cmp = entry.generatedLine - line || entry.generatedColumn - column;
    if (cmp === 0) {
      return entry;
    } else if (cmp < 0) {
      best = mid;
 ...
 */ class SourceMap {
   ...
   */ constructor(payload, options){
    if (typeof payload !== "object" || payload === null || ArrayIsArray(payload)) {
      let received;
      if (payload === null) {
        ...
        received = name ? ` Received an instance of ${name}` : ` Received ${typeof payload}`;
      } else {
    ...
    this.#lineLengths = options?.lineLengths ? ArrayPrototypeSlice(options.lineLengths) : undefined;
   ...
   */ #parseMap(payload) {
    if (payload.sections) {
      ...
      for(let i = 0; i < sections.length; i++){
        ...
        const sectionEntries = parseMappings(map.mappings, map.sources || [], map.names || [], map.sourceRoot || "");
    ...
    return parseMappings(payload.mappings, payload.sources || [], payload.names || [], payload.sourceRoot || "");
  }
  /**
   ...
   */ findOrigin(lineNumber, columnNumber) {
    ...
    if (entry.originalSource === undefined || entry.originalLine === undefined || entry.originalColumn === undefined || entry.generatedLine === undefined || entry.generatedColumn === undefined) {
      return {};
    }
...
const SOURCE_MAP_URL_RE = /\/\/[#@]\s*sourceMappingURL\s*=\s*(\S+)\s*(?:\n|\r\n?)?$/;
/**
 ...
 */ function resolveSourceMapPayload(url, filePath) {
  ...
  if (StringPrototypeStartsWith(url, "data:")) {
    const dataUrlMatch = StringPrototypeMatch(url, /^data:application\/json;(?:charset=utf-?8;)?base64,(.+)$/);
    if (dataUrlMatch) {
      try {
 ...
 */ export function findSourceMap(path) {
  ...
  try {
    ...
    const lines = StringPrototypeSplit(StringPrototypeReplace(content, /\n$/, ""), "\n");
    const lineLengths = [];
 ...
 */ export function stripTypeScriptTypes(code, options = undefined) {
  ...
  if (mode !== "strip" && mode !== "transform") {
    throw new internalErrors.ERR_INVALID_ARG_VALUE("options.mode", mode, "must be one of: 'strip', 'transform'");
  }
  if (options?.sourceMap !== undefined && typeof options.sourceMap !== "boolean") {
    throw new internalErrors.ERR_INVALID_ARG_TYPE("options.sourceMap", "boolean", options.sourceMap);
  }
  if (options?.sourceUrl !== undefined && typeof options.sourceUrl !== "string") {
    throw new internalErrors.ERR_INVALID_ARG_TYPE("options.sourceUrl", "string", options.sourceUrl);
  }
  const sourceMap = options?.sourceMap === true;
  if (mode === "strip" && sourceMap) {
    throw new internalErrors.ERR_INVALID_ARG_VALUE("options.sourceMap", sourceMap, "must be one of: false, undefined");
  }
  let result;
  try {
...
function initialize(args) {
  const { usesLocalNodeModulesDir: usesLocalNodeModulesDirArg, argv0, runningOnMainThread, workerId, maybeWorkerMetadata, nodeDebug, nodeClusterUniqueId, nodeClusterSchedPolicy, warmup = false, moduleSpecifier = null } = args;
  if (!warmup) {
    if (initialized) {
    ...
    internals.__bootstrapNodeProcess(argv0, Deno.args, Deno.version, nodeDebug ?? "", false, runningOnMainThread);
    internals.__initWorkerThreads(runningOnMainThread, workerId, maybeWorkerMetadata, moduleSpecifier);
    ...
    nativeModuleExports["internal/console/constructor"].bindStreamsLazy(nativeModuleExports["console"], nativeModuleExports["process"]);
    nativeModuleExports["internal/console/constructor"].bindStreamsLazy(globalThis.console, nativeModuleExports["process"]);
  } else {
    internals.__bootstrapNodeProcess(undefined, undefined, undefined, undefined, true);
  }
}
...
function preEnableTraceEvents() {
  ...
  const traceCategoriesEnv = op_get_env_no_permission_check("DENO_NODE_TRACE_EVENT_CATEGORIES");
...
export { builtinModules, createRequire, findPackageJSON, getBuiltinModule, isBuiltin, Module, SourceMap, syncBuiltinESMExports };
